...
def test_default_project_to_default_dist():
    ...
    assert conv('include/test.hpp')[1] == conv.anchor / Path('include/test.hpp')
    assert conv('/full/path/to/include/test.hpp')[1] == conv.anchor / Path('include/test.hpp')
    assert conv('include/lvl1/test.hpp')[1] == conv.anchor / Path('include/lvl1/test.hpp')
    assert conv('/full/path/to/include/lvl1/test.hpp')[1] == conv.anchor / Path('include/lvl1/test.hpp')
    assert conv('/full/path/to/include/1/2/3/4/5/6/7/8/9/test.hpp')[1] == conv.anchor / Path('include/1/2/3/4/5/6/7/8/9/test.hpp')
